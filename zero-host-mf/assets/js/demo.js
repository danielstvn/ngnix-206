...
(function ($) {
  ...
  */
  ...
  $container.append("<h6>Sidebar Top Xoftix</h6>");

  var $sidebar_top = $("<input />", {
    type: "checkbox",
    value: 1,
    checked: $("body").hasClass("sidebar-top"),
    class: "mr-1",
  }).on("click", function () {
    if ($(this).is(":checked")) {
      $("body").addClass("sidebar-top");
      document.getElementById("btn1").style.display = "none";
      document.getElementById("topbar").style.display = "block";
      document.getElementById("slidertopbar").style.display = "none";
      $("body").addClass("sidebar-collapse");
      $("body").removeClass("sidebar-mini");
      $("body").removeClass("slider-sidebar-top");
  ...
  var $sidebar_top_container = $("<div />", { class: "mb-1" })
    .append($sidebar_top)
    .append("<span>Sidebar top</span>");
  $container.append($sidebar_top_container);

  var $slider_sidebar_top = $("<input />", {
    type: "checkbox",
    value: 1,
    checked: $("body").hasClass("slider-sidebar-top"),
    class: "mr-1",
  }).on("click", function () {
    if ($(this).is(":checked")) {
      $("body").addClass("slider-sidebar-top");
      document.getElementById("btn1").style.display = "none";
      document.getElementById("slidertopbar").style.display = "block";
      document.getElementById("topbar").style.display = "none";
      $("body").addClass("sidebar-collapse");
      $("body").removeClass("sidebar-mini");
      $("body").removeClass("sidebar-top");
  ...
  var $slide_sidebar_top_container = $("<div />", { class: "mb-4" })
    .append($slider_sidebar_top)
    .append("<span>Slide sidebar top</span>");
  $container.append($slide_sidebar_top_container);

  //----------------
  $container.append($no_border_container);

  $container.append("<h6>Dark Mode</h6>");
